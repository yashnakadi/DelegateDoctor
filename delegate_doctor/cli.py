...
def main(argv: Optional[list] = None) -> int:
    ...
    optimize = subparsers.add_parser(
        ...
        description=(
            ...
            "\n"
            "DelegateDoctor prefers a connected physical arm64-v8a Android\n"
            "device. If none is available, an already-running arm64-v8a Android\n"
            "emulator may be used as a best-effort target; DelegateDoctor does\n"
            "not provision or validate emulator environments.\n"
            "\n"
