...
Architecture:  U-Net++ (nested U-Net decoder with dense skip connections)
...
Run:  delegate-doctor doctor unetplusplus
"""

from delegate_doctor.export_model import ModelSpec
from delegate_doctor.models import build_model_spec, create_unetplusplus
...
def build_model() -> ModelSpec:
    """What `delegate-doctor doctor unetplusplus` loads."""
    return build_model_spec("unetplusplus")
