"""Demo workload: FPN with a MobileNetV2 encoder, 21 classes.

Architecture:  FPN (feature pyramid decoder)
...
Run:  delegate-doctor doctor fpn
"""

from delegate_doctor.export_model import ModelSpec
from delegate_doctor.models import build_model_spec, create_fpn


def create_model():
    """The bare FPN, if you want it without DelegateDoctor's wrapper."""
    return create_fpn()


def build_model() -> ModelSpec:
    """What `delegate-doctor doctor fpn` loads."""
    return build_model_spec("fpn")
